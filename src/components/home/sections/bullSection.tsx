...
export default function BullSection() {
  return (
    <section className="section2 bg-background   top-0 -z-40 h-[100vh] w-screen overflow-clip">
      <div className="z-999  top-0 flex h-[100vh] w-screen items-center bg-secondary_100">
        ...
        <div className=" z-[900] flex h-full w-1/3 flex-col justify-center  p-10">
          ...
          <AnimatedTextCharacter>
            O futuro da pecuária na palma da sua mão! Acompanhe as cotações
            atuais do boi e tome decisões estratégicas para seu negócio. Com o
            'Agro na Mão', você tem acesso a dados confiáveis para negociar com
            confiança e eficiência. Não fique para trás, baixe o aplicativo e
            lidere o mercado!
          </AnimatedTextCharacter>
          <AboutButton />
        </div>
