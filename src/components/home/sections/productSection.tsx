...
export default function ProductSection() {
  return (
    <section className="section2 bg-background   top-0  h-[100vh] w-screen overflow-clip">
      <div className=" top-0  flex h-[100vh] w-screen items-center bg-secondary_100 p-10">
        <div className="item-center z-[999] flex h-full w-1/3 flex-col justify-center">
          <MotionDivFromBottom>
        ...
        <div className=" z-[999] flex h-full w-1/3 flex-col justify-center  p-10">
          <MotionDivFromTop>
          ...
          <AnimatedTextCharacter>
            ...
            melhores produtos agrícolas, desde defensivos até vacinas para o
            gado. O 'Agro na Mão' traz recomendações personalizadas ara suas
            necessidades. Otimize suas colheitas e criações com produtos de
            ponta. Baixe o aplicativo e inove no seu agro!
          </AnimatedTextCharacter>
          <AboutButton />
        </div>
      </div>
